...
console.log("The variable time is an array that consists different types of data. Array.isArray(time) returns true which means an array can consists of multiple data types");
